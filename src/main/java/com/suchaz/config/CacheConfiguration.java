...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SuchAZSampleMicroServices");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SuchAZSampleMicroServices");
        ...
        config.getMapConfigs().put("com.suchaz.domain.*", initializeDomainMapConfig(jHipsterProperties));
